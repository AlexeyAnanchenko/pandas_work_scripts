...
NAME_TRAD = '<ТРАДИЦИЯ>'
SALES_FACTOR_PERIOD = 'Продажи по периоду фактора'
AVG_FACTOR_PERIOD = 'Средние продажи + урезания клиента по периоду фактора'
RSV_FACTOR_PERIOD = 'Резервы по периоду фактора'
